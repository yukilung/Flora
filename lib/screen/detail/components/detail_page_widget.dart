          ...
          sliver: SliverList(
            delegate: SliverChildListDelegate(
              [
                ...
                specialFeatures != ''
                    ? SectionCell(
                        assetsUrl: 'assets/icons/sp_features.svg',
                ...
                learnMore != ''
                    ? SectionCell(
                        assetsUrl: 'assets/icons/information.svg',
                        title: AppLocalizations.of(context).treeToLearnMore,
                        content: learnMore,
                      )
                    : SizedBox(),
                SectionCell(
                  assetsUrl: 'assets/icons/characteristics.svg',
                ...
                leafIntro != ''
                    ? SectionCell(
                        assetsUrl: 'assets/icons/leaf.svg',
                ...
                flowerIntro != ''
                    ? SectionCell(
                        assetsUrl: 'assets/icons/flower.svg',
                ...
                fruitIntro != ''
                    ? SectionCell(
                        assetsUrl: 'assets/icons/fruit.svg',
                ...
                resource != ''
                    ? Column(
                        children: [
                          SectionCell(
                            assetsUrl: 'assets/icons/plant_earth.svg',
